...
public class MimeMap {
    ...
    enum Supported{ SUPPORTED,NOT_SUPPORTED}
    ...
    public static class MimeData {
        ...
        public MimeData(final String ext, final String mimeType,final String mediaType, final Supported supported) {
    ...
    public static final List<MimeData> mimeTypes = Arrays.asList(
            new MimeData(EXT_MP3, MIME_AUDIO_MPEG3, AUDIO, Supported.SUPPORTED),
            new MimeData(EXT_MP3, MIME_AUDIO_MP3, AUDIO, Supported.SUPPORTED),
            new MimeData(EXT_MP3, MIME_X_AUDIO_MP3, AUDIO, Supported.SUPPORTED),
            new MimeData(EXT_MP3, MIME_AUDIO_MPEG, AUDIO, Supported.SUPPORTED),
            new MimeData(EXT_AVI, MIME_VIDEO_AVI, VIDEO, Supported.NOT_SUPPORTED),
            new MimeData(EXT_WMV, MIME_VIDEO_X_MS_WMV, VIDEO, Supported.SUPPORTED),
            new MimeData(EXT_3GP, MIME_VIDEO_3GPP, VIDEO, Supported.SUPPORTED),
            new MimeData(EXT_3GP, MIME_AUDIO_3GPP, AUDIO, Supported.SUPPORTED),
            new MimeData(EXT_3GPP, MIME_VIDEO_3GPP, VIDEO, Supported.SUPPORTED),
            new MimeData(EXT_MP4, MIME_VIDEO_MP4, VIDEO, Supported.SUPPORTED),
            new MimeData(EXT_MP4, MIME_AUDIO_MP4, AUDIO, Supported.SUPPORTED),
            new MimeData(EXT_WMA, MIME_AUDIO_X_MS_WMA, AUDIO, Supported.SUPPORTED),
            new MimeData(EXT_M4A, MIME_AUDIO_MP4, AUDIO, Supported.SUPPORTED),
            new MimeData(EXT_M4A, MIME_AUDIO_X_M4A, AUDIO, Supported.SUPPORTED),
            new MimeData(EXT_M4V, MIME_VIDEO_MP4, VIDEO, Supported.SUPPORTED),
            new MimeData(EXT_M4V, MIME_VIDEO_X_M4V, VIDEO, Supported.SUPPORTED),
            new MimeData(EXT_OGG, MIME_AUDIO_OGG, AUDIO, Supported.SUPPORTED),
            new MimeData(EXT_OGG, MIME_VIDEO_OGG, VIDEO, Supported.SUPPORTED),
            new MimeData(EXT_OGA, MIME_AUDIO_OGG, AUDIO, Supported.SUPPORTED),
            new MimeData(EXT_OGG, MIME_APPLICATION_OGG, AUDIO_VIDEO, Supported.SUPPORTED),
            new MimeData(EXT_OGV, MIME_VIDEO_OGG, VIDEO, Supported.SUPPORTED),
            new MimeData(EXT_WAV, MIME_AUDIO_X_WAV, AUDIO, Supported.SUPPORTED),
            new MimeData(EXT_GIF, MIME_IMAGE_GIF, IMAGE, Supported.SUPPORTED),
            new MimeData(EXT_PNG, MIME_IMAGE_PNG, IMAGE, Supported.SUPPORTED),
            new MimeData(EXT_JPG, MIME_IMAGE_JPEG, IMAGE, Supported.SUPPORTED),
            new MimeData(EXT_JPEG, MIME_IMAGE_JPEG, IMAGE, Supported.SUPPORTED),
            new MimeData(EXT_BMP, MIME_IMAGE_BMP, IMAGE, Supported.SUPPORTED),
            new MimeData(EXT_ICO, MIME_IMAGE_ICON, IMAGE, Supported.SUPPORTED),
            new MimeData(EXT_MP4, MIME_VIDEO_QUICKTIME, VIDEO, Supported.SUPPORTED),
            new MimeData(EXT_MOV, MIME_VIDEO_QUICKTIME, VIDEO, Supported.NOT_SUPPORTED),
            new MimeData(EXT_AAC, MIME_AUDIO_AAC, AUDIO, Supported.NOT_SUPPORTED),
            new MimeData(EXT_FLAC, MIME_AUDIO_FLAC, AUDIO, Supported.NOT_SUPPORTED),
            new MimeData(EXT_ZIP, MIME_APPLICATION_ZIP, OTHER, Supported.NOT_SUPPORTED),
            new MimeData(EXT_GZIP, MIME_APPLICATION_X_GZIP, OTHER, Supported.NOT_SUPPORTED),
            new MimeData(EXT_GZ, MIME_APPLICATION_X_GZIP, OTHER, Supported.NOT_SUPPORTED),
            new MimeData(EXT_SWF, MIME_APPLICATION_X_SHOCKWAVE_FLASH, FLASH, Supported.NOT_SUPPORTED),
            new MimeData(EXT_MP4, MIME_VIDEO_VND_OBJECTVIDEO, VIDEO, Supported.SUPPORTED),
            new MimeData(EXT_MP4, MIME_AUDIO_VND_OBJECTAUDIO, AUDIO, Supported.SUPPORTED),
            new MimeData(EXT_MP4, MIME_VIDEO_MPEG2, VIDEO, Supported.SUPPORTED),
            new MimeData(EXT_HTML, MIME_TEXT_HTML, WEB, Supported.SUPPORTED),
            new MimeData("", MIME_TEXT_HTML, WEB, Supported.SUPPORTED),
            new MimeData(EXT_TXT, MIME_TEXT_PLAIN, DOC, Supported.SUPPORTED),
            new MimeData(EXT_PDF, MIME_APPLICATION_PDF, DOC, Supported.SUPPORTED),
            new MimeData(EXT_PDF, MIME_APPLICATION_X_PDF, DOC, Supported.SUPPORTED)
    );
