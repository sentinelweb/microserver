...
public abstract class CommandProcessor {
	...
	public static enum ErrorTags {ERROR,WARNING,INFO,SUCCESS}
	...
	public CommandProcessor() {
		super();
		final CommandProcessor c = getCommandProcessor(getCommand());
		if (c!=null) {
			return;
		}
		if (!commands.keySet().contains(this.getClass())) {
			commands.put(this.getClass(),this);
		}
	...
	public static CommandProcessor getCommandProcessor(final String command){
		for (final CommandProcessor c : commands.values()) {
	...
	public static void releaseCommands(){
		for (final CommandProcessor c :commands.values()) {
			c.release();
		}
		commands.clear();
    ...
    public HashMap<String,String> getDefaultHeaders() {
        ...
        headers.put("Server", "MyPOD Android");
...
//		sw.write("Date: "+new Date().toGMTString()+" GMT\r\n");
//		sw.write("Server: MyPOD Android"+"\r\n");
//		sw.write("Last-Modified: "+new Date().toGMTString()+" GMT\r\n");
